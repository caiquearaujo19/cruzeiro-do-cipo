...
import EmblemCipoColor from '../../assets/emblems/emblem-cipo-color.png'
import EmblemCipoWhite from '../../assets/emblems/emblem-cipo-white.png'
  ...
  return (
    shape !== undefined ?
      <span className={colorful ? 'emblem emblem--colorful' : 'emblem'}>
        {shapes[shape]}
      </span> : <img className="emblem" src={colorful ? EmblemCipoColor : EmblemCipoWhite} alt="Cruzeiro do Cipó"/>
    )
}